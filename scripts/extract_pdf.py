...
NO_SPACE_FIXES = {
    ...
    "optiontousetocombinethecustomertables": "Option to use to combine the Customer tables",
    "actiontoperformontheoriginaltwosqldatabasequeries": "Action to perform on the original two SQL database queries",
    "deletethequery": "Delete the query",
    "deletethequeries": "Delete the queries",
    "duplicatethequeries": "Duplicate the queries",
    "excludethequeryfromreportrefresh": "Exclude the query from report refresh",
    "thedefaulttimeoutfortheconnectionfrompowerbidesktoptothedatabasewillbe": "The default timeout for the connection from Power BI Desktop to the database will be",
    "allthetables": "all the tables",
    "answerareatoreplacealltheimplicitdaxmeasuresusedinthevisualanswerchoicemustbecreated": "To replace all the implicit DAX measures used in the visual, [answer choice] must be created.",
    "tochangehowtheproductcostfieldisaggregatedinadditionalvisualsyoumustchangetheanswerchoice": "To change how the Product Cost field is aggregated in additional visuals, you must change the [answer choice].",
    "answerareaselectingaquarteronthelinechartwillanswerchoicetheclusteredcolumnchart": "Selecting a quarter on the line chart will [answer choice] the clustered column chart.",
    "selecttheshowvalueasoption": "Select the Show value as option",
    "populatetheaxiswithadatefield": "Populate the axis with a date field",
    "thedatamodelisorganizedintoaanswerchoice": "The data model is organized into a [answer choice]",
    "snowflakeschema": "snowflake schema",
    "denormalizedtable": "denormalized table",
    "attendancefact": "Attendance fact",
    "classdimension": "Class dimension",
    "teacherdimension": "Teacher dimension",
    "teacherfact": "Teacher fact",
    "addingmorefieldstoexplainby": "adding more fields to Explain by",
    "addingmorefieldstoexpandby": "adding more fields to Expand by",
    "are20valuesthatoccur": "are 20 values that occur",
    "are365valuesthatoccur": "are 365 values that occur",
    "isonevaluethatoccurs": "is one value that occurs",
    "linechartmarkers": "line chart markers",
    "acolumnchartofquantityorderedandunitpricebyyear": "A column chart of Quantity Ordered and Unit Price by year",
    "alinechartofquantityorderedandunitpricebyitem": "A line chart of Quantity Ordered and Unit Price by item",
    "ascatterplotofquantityorderedandunitpricebyitem": "A scatter plot of Quantity Ordered and Unit Price by item",
    "automaticallyfindclusters": "Automatically find clusters",
    "findwherethedistributionisdifferent": "Find where the distribution is different",
    "grantthebuildpermissionfor": "grant the Build permission for",
    "removeatablefrom": "remove a table from",
    "createaonetoone": "Create a one-to-one",
    "orderstable": "Orders table",
    "supplierstable": "Suppliers table",
    "orderdetailstable": "Order Details table",
    "customerdetailsworksheet": "Customer Details worksheet",
}
